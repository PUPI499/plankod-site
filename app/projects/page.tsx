    ...
    <main>
      ...
      <section className="design-capabilities shell">
        ...
        <div className="design-list">
          <article><span>01</span><h3>Объекты любой сложности</h3><p>Частные дома, производственные цеха, кинозалы, отели, офисы, рестораны и комплексы зданий.</p><b>генеральные решения</b></article>
          <article><span>02</span><h3>Вентиляция</h3><p>Приток, вытяжка, фильтрация и шум — от квартиры до цеха пищевого производства.</p><b>ОВ / промышленность</b></article>
          <article><span>03</span><h3>Отопление</h3><p>Расчёты, оборудование, разводка, зоны, автоматика и управление температурой.</p><b>ОВ / автоматизация</b></article>
          ...
          <article><span>05</span><h3>Климат общественных пространств</h3><p>Кинозалы и залы: расчёт воздухообмена и бесшумных систем при полной посадке.</p><b>кинозалы / залы</b></article>
          <article><span>06</span><h3>Фасадные системы обогрева</h3><p>Греющий кабель и панели против наледи и промерзания кровель, входов и фасадов.</p><b>антиобледенение</b></article>
          <article><span>07</span><h3>Инженерия комплексов</h3><p>Генеральные решения для одного здания и для группы зданий на одной территории.</p><b>мастер-план</b></article>
          <article><span>08</span><h3>Умный дом</h3><p>Сценарии, датчики, исполнительные устройства и связь с инженерными системами.</p><b>проект + программирование</b></article>
          <article><span>09</span><h3>Архитектурная затравка</h3><p>Общее проектирование дома можем обсуждать как дополнительное направление.</p><b>дополнительная услуга</b></article>
        </div>
      </section>
