...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Проектирование — ПЛАНКОД", description: "Инженерные проекты частных домов, производственных и коммерческих объектов.", images: [] },
  twitter: { title: "Проектирование — ПЛАНКОД", description: "Портфолио инженерных проектов любой сложности.", images: [] },
};
